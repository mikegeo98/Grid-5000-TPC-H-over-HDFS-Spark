...
spark = SparkSession.builder.appName("Query7_DFAPI").config("spark.executor.instances","4").config("spark.executor.cores","4").master("yarn").getOrCreate()
...
print("Partitions : Lineitem Orders Customer Supplier Nation Region",tmp1,tmp2,tmp3,tmp4,tmp5,tmp6)
